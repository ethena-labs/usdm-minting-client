# USDm Minting API Documentation

API documentation server for the USDm minting API, powered by Scalar and OpenAPI.
...
The documentation server provides documentation for the following USDm API endpoints:

- `GET /rfq` - Get a quote for minting or redeeming USDm tokens
