 ...
 * @description Get a quote for minting or redeeming USDm tokens. Returns the required collateral amount and USDm amount for the specified order size.
